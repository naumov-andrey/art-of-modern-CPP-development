...
int main() {
  ...
  auto t = tasks.PerformPersonTasks("Alice", 5);
  PrintTasksInfo(get<0>(t));
  PrintTasksInfo(get<1>(t));
  cout << '\n';

  t = tasks.PerformPersonTasks("Alice", 5);
  PrintTasksInfo(get<0>(t));
  PrintTasksInfo(get<1>(t));
  cout << '\n';

  t = tasks.PerformPersonTasks("Alice", 1);
  PrintTasksInfo(get<0>(t));
  PrintTasksInfo(get<1>(t));
  cout << '\n';
  ...
  t = tasks.PerformPersonTasks("Alice", 2);
  PrintTasksInfo(get<0>(t));
  PrintTasksInfo(get<1>(t));
  cout << '\n';

  t = tasks.PerformPersonTasks("Alice", 4);
  PrintTasksInfo(get<0>(t));
  PrintTasksInfo(get<1>(t));
  cout << '\n';
